            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="notice_cont" name="notice_cont" required rows="15"
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 resize-none font-mono text-sm">${notice.notice_cont}</textarea>
