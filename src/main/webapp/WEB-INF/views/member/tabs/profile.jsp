    ...
    <div id="view-mode" class="space-y-8 animate-[fadeIn_0.3s_ease-out]">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
                ...
                <span class="text-gray-900 font-bold text-lg">${sessionScope.loginSess.member_nicknm}</span>
            </div>
            <div>
                <span class="text-xs font-bold text-gray-400 block mb-2 uppercase tracking-wider">이메일</span>
                <span class="text-gray-900 font-bold text-lg">${sessionScope.loginSess.member_email}</span>
            </div>
            <div>
                <span class="text-xs font-bold text-gray-400 block mb-2 uppercase tracking-wider">휴대폰 번호</span>
                <span class="text-gray-900 font-bold text-lg tracking-tight">${not empty sessionScope.loginSess.member_tel_no ? sessionScope.loginSess.member_tel_no : '미등록'}</span>
            </div>
        </div>
