            ...
            <body>
                ...
                <main class="bookclub-main">
                    <div class="container">
                        ...
                        <!-- 검색 및 필터 -->
                        <%-- <form action="${pageContext.request.contextPath}/bookclubs" method="get"
                            class="search-form">
                            <div class="search-row">
                                <div class="search-field">
                                    <label for="keyword" class="sr-only">검색어</label>
                                    <input type="text" id="keyword" name="keyword" placeholder="모임 이름 검색"
                                        value="<c:out value='${keyword}'/>" class="form-input">
                                </div>
                                ...
                                <div class="search-field">
                                    ...
                                    <select id="sort" name="sort" class="form-select">
                                        ...
                                        <option value="newest" ${bookclubList.sort eq 'newest' ? 'selected' : '' }>최신순
                                        </option>
                                        <option value="popular" ${bookclubList.sort eq 'popular' ? 'selected' : '' }>인기순
                                        </option>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-members">
                                                            <%-- <span class="members-count">${club.memberCount}</span>
                                                                --%>
                                                                <span
                                                                    class="members-max">/${club.book_club_max_member}명</span>
                                                        </p>
                                                    </div>
                                                </a>
                                                <%-- <button type="button"
