...
<style>
    ...
    .bc-forbidden-btn-secondary {
        background: #e2e8f0;
        color: #4a5568;
    }

    .bc-forbidden-btn-secondary:hover {
        background: #cbd5e0;
    }
</style>
...
<div class="bc-forbidden-wrapper">
    <div class="bc-forbidden-card">
        ...
        <div class="bc-forbidden-actions">
            ...
            <%-- 로그인 버튼 (선택) --%>
            <button type="button" onclick="redirectToLogin()" class="bc-forbidden-btn bc-forbidden-btn-secondary">
                <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
