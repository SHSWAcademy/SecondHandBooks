...
<body>
    ...
    <main class="bookclub-main">
        <div class="container">
            ...
            <form action="${pageContext.request.contextPath}/bookclubs"
                  method="post"
                  id="createForm"
                  class="create-form"
                  novalidate>
                ...
                <div class="form-group ${not empty errors.name ? 'has-error' : ''}">
                    ...
                    <c:if test="${not empty errors.name}">
                        <p class="form-error"><c:out value="${errors.name}"/></p>
                    </c:if>
                </div>
                ...
                <div class="form-group ${not empty errors.desc ? 'has-error' : ''}">
                    ...
                    <c:if test="${not empty errors.desc}">
                        <p class="form-error"><c:out value="${errors.desc}"/></p>
                    </c:if>
                </div>
                ...
                <div class="form-group ${not empty errors.region ? 'has-error' : ''}">
                    ...
                    <c:if test="${not empty errors.region}">
                        <p class="form-error"><c:out value="${errors.region}"/></p>
                    </c:if>
                </div>
                ...
                <div class="form-group ${not empty errors.maxMember ? 'has-error' : ''}">
                    ...
                    <input type="number"
                           ...
                           class="form-input"
                           placeholder="예: 10"
                           value="<c:out value='${param.maxMember}'/>"
                           min="2"
                           max="100"
                           required
                           aria-required="true"
                           aria-describedby="maxMemberHelp">
                    <p id="maxMemberHelp" class="form-help">2-100명 사이로 설정해주세요.</p>
                    <c:if test="${not empty errors.maxMember}">
                        <p class="form-error"><c:out value="${errors.maxMember}"/></p>
                    </c:if>
                </div>
                ...
                <div class="form-group ${not empty errors.schedule ? 'has-error' : ''}">
                    ...
                    <input type="text"
                           ...
                           name="schedule"
                           class="form-input"
                           placeholder="예: 매주 금요일 저녁 7시"
                           value="<c:out value='${param.schedule}'/>"
                           maxlength="100"
                           required
                           aria-required="true"
                    ...
                    <c:if test="${not empty errors.schedule}">
                        <p class="form-error"><c:out value="${errors.schedule}"/></p>
                    </c:if>
                </div>
                ...
                <div class="form-group ${not empty errors.bannerImgUrl ? 'has-error' : ''}">
                    ...
                    <input type="url"
                           ...
                           value="<c:out value='${param.bannerImgUrl}'/>"
                    ...
                    <c:if test="${not empty errors.bannerImgUrl}">
                        <p class="form-error"><c:out value="${errors.bannerImgUrl}"/></p>
                    </c:if>
                </div>
