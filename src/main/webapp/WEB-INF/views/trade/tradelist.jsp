                    ...
                    <div class="flex-1 flex flex-col px-1">
                        ...
                        <div class="text-xs text-gray-500 font-medium mb-1.5 truncate">
                            ...
                            <c:if test="${not empty trade.book_publisher}">
                                <span class="mx-1 text-gray-300 text-[10px]">|</span> ${trade.book_publisher}
                            </c:if>
                        </div>

                        <c:if test="${not empty trade.sale_title}">
                            <p class="text-xs text-gray-600 font-normal mb-2 truncate opacity-80">${trade.sale_title}</p>
                        </c:if>
                        ...
                        <div class="mt-auto pt-1">
                            ...
                            <div class="flex items-center text-[11px] text-gray-400 font-medium">
                                ...
                                <span class="truncate max-w-[100px]">${trade.sale_rg}</span>
                            </div>
                        </div>
                    </div>
                </div>
