    ...
    .subscribe(); <span class="text-green-400">// Async Callback</span>
            ...
            <section class="py-32 bg-white border-t border-gray-100">
                <div class="max-w-6xl mx-auto px-6">
                    <div class="text-center mb-16 reveal-text">
                        <span class="text-red-600 font-bold tracking-wider text-sm uppercase mb-2 block">Security
                            First</span>
                        <h2 class="text-4xl font-bold mb-4 text-gray-900">Security Hardening</h2>
                        <p class="text-gray-500 font-medium">CSRF 및 XSS 공격에 대한 방어 전략</p>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="bento-box p-8 reveal-card border border-gray-200">
                            <div class="flex items-center gap-4 mb-6">
                                <div class="p-3 bg-red-100 text-red-600 rounded-xl">
                                    <i data-lucide="shield-check" class="w-6 h-6"></i>
                                </div>
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900">CSRF 대응</h3>
                                    <p class="text-xs text-red-600 font-bold mt-0.5">403 → 200 안전 전환</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="bg-gray-50 p-5 rounded-2xl border border-gray-100">
                                    <h4 class="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                                        <i data-lucide="lock" class="w-4 h-4 text-gray-400"></i> 적용 범위
                                    </h4>
                                    <div class="space-y-2">
                                        <div class="flex items-start gap-2">
                                            <i data-lucide="check" class="w-4 h-4 text-green-500 mt-0.5 shrink-0"></i>
                                            <p class="text-sm text-gray-600 leading-snug"><code
                                                    class="px-1.5 py-0.5 bg-white border border-gray-200 rounded text-xs font-mono text-red-600">/bookclubs</code>
                                                POST/PUT/DELETE</p>
                                        </div>
                                        <div class="flex items-start gap-2">
                                            <i data-lucide="check" class="w-4 h-4 text-green-500 mt-0.5 shrink-0"></i>
                                            <p class="text-sm text-gray-600 leading-snug">GET 요청 제외 (조회 성능 유지)</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-orange-50/50 p-5 rounded-2xl border border-orange-100">
                                    <h4 class="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                                        <i data-lucide="git-branch" class="w-4 h-4 text-orange-500"></i> 예외 처리 (UX)
                                    </h4>
                                    <div class="grid grid-cols-1 gap-3">
                                        <div class="flex items-center gap-3">
                                            <span
                        ...
                        <div class="bento-box p-8 reveal-card border border-gray-200" style="transition-delay: 100ms;">
                            <div class="flex items-center gap-4 mb-6">
                                <div class="p-3 bg-orange-100 text-orange-600 rounded-xl">
                                    <i data-lucide="code" class="w-6 h-6"></i>
                                </div>
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900">XSS 방어</h3>
                                    <p class="text-xs text-orange-600 font-bold mt-0.5">Input & Output Filtering</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="bg-gray-50 p-5 rounded-2xl border border-gray-100">
                                    <h4 class="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                                        <i data-lucide="shield" class="w-4 h-4 text-gray-400"></i> 출력 이스케이프
                                    </h4>
                                    <div class="space-y-2">
                                        <div class="flex items-start gap-2">
                                ...
                                <div class="bg-red-50/50 p-5 rounded-2xl border border-red-100">
                                    <h4 class="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                                        <i data-lucide="upload" class="w-4 h-4 text-red-500"></i> 파일 업로드 검증
                                    </h4>
                                    <div class="grid grid-cols-2 gap-3">
                                        <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm">
                                            <p class="text-[10px] font-bold text-gray-400 uppercase mb-1">Type</p>
                                            <p class="text-xs font-bold text-gray-800">JPG, PNG Only</p>
                                        </div>
                                        <div class="bg-white p-3 rounded-xl border border-gray-100 shadow-sm">
                                            <p class="text-[10px] font-bold text-gray-400 uppercase mb-1">Block</p>
                                            <p class="text-xs font-bold text-red-600">SVG (Script 위험)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <h3 class="text-lg font-bold">Key Insight</h3>
                                    </div>
                                    <p class="text-gray-400 text-sm leading-relaxed mb-6">
                                        레거시 코드 전체에 CSRF를 전면 적용하는 것은 리스크가 큽니다.
                                        따라서 <span class="text-white font-bold underline decoration-red-500">실제 데이터 변경이
                                            일어나는 구간</span>부터 점진적으로 적용하여 장애 위험을 최소화했습니다.
                                    </p>
                                    <div class="flex gap-4">
                                        <div class="flex items-center gap-2 text-xs text-gray-300">
                                            <i data-lucide="minimize" class="w-4 h-4"></i> 장애 최소화
                                        </div>
                                        <div class="flex items-center gap-2 text-xs text-gray-300">
                                            <i data-lucide="target" class="w-4 h-4"></i> 핵심 보호
                                        </div>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div class="space-y-3">
                                        <div class="flex justify-between items-center text-sm">
                                            <span class="text-gray-300">CSRF</span>
                                            <span class="text-white font-bold">Applied</span>
                                        </div>
                                        <div class="flex justify-between items-center text-sm">
                                            <span class="text-gray-300">XSS</span>
                                            <span class="text-white font-bold">Filtered</span>
                                        </div>
                                        <div class="flex justify-between items-center text-sm">
                                            <span class="text-gray-300">File Upload</span>
                                            <span class="text-white font-bold">Validated</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
