            ...
            <div class="relative">
                ...
                <div id="categoryDropdown" class="hidden absolute top-full left-0 mt-2 w-56 bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-100 z-30 py-2 max-h-[300px] overflow-y-auto animate-fade-in-down">
                    ...
                    <c:forEach var="cat" items="${category}">
                        <a href="javascript:selectCategory(${cat.category_seq}, '${cat.category_nm}')" class="block px-5 py-2.5 text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                                ${cat.category_nm}
                        </a>
                    </c:forEach>
                </div>
