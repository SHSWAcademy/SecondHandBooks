        ...
        <div class="max-w-7xl mx-auto px-6 h-[72px] flex items-center justify-between">
          ...
          <div class="flex items-center gap-2 cursor-pointer mr-10" onclick="location.href='/home'">
            <div class="flex flex-col leading-none">
              ...
              <span class="text-2xl font-black text-primary-600 tracking-tighter">Shinhan<span
                  class="text-gray-800 font-bold ml-1">Books</span></span>
            </div>
          </div>
          ...
          <div class="hidden md:flex flex-1 max-w-2xl relative">
            <form action="/home" method="get" class="w-full">
              ...
              <button type="submit"
                class="absolute right-2 top-1.5 h-9 w-9 bg-primary-500 rounded-full flex items-center justify-center text-white hover:bg-primary-600 transition">
          ...
          <nav class="flex items-center gap-4 ml-8">
            ...
            <c:choose>
              ...
              <c:otherwise>
                <a href="/login"
                  class="px-5 py-2.5 bg-primary-500 hover:bg-primary-600 text-white rounded-md text-sm font-bold transition-all shadow-sm hover:shadow-md">로그인</a>
              </c:otherwise>
            </c:choose>
          </nav>
        </div>
